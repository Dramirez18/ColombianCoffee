...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'A deeper, fuller-bodied expression of our regional blend (Agtron 45–55). Roasted slightly longer to bring out chocolate intensity while preserving the bright caramel sweetness and a cherry-like finish. Excellent for espresso and stovetop methods. Whole bean only — no ground coffee available.',
    origin: 'Huila · Pereira · Santa Marta (seasonal)',
